 ...
 * </p>
 * <ul>
 *   <li>{@link bpmnpl_variability.impl.UnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link bpmnpl_variability.impl.UnaryExpressionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	protected EClass eStaticClass() {
		return Bpmnpl_variabilityPackage.Literals.UNARY_EXPRESSION;
	}
	...
	public void setOperator(UnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmnpl_variabilityPackage.UNARY_EXPRESSION__OPERATOR,
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bpmnpl_variabilityPackage.UNARY_EXPRESSION__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmnpl_variabilityPackage.UNARY_EXPRESSION__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmnpl_variabilityPackage.UNARY_EXPRESSION__RIGHT,
					newRight, newRight));
	}
