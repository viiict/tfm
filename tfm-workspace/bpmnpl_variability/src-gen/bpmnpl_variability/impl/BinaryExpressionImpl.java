 ...
 * </p>
 * <ul>
 *   <li>{@link bpmnpl_variability.impl.BinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link bpmnpl_variability.impl.BinaryExpressionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link bpmnpl_variability.impl.BinaryExpressionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryExpressionImpl extends ExpressionImpl implements BinaryExpression {
	...
	protected EClass eStaticClass() {
		return Bpmnpl_variabilityPackage.Literals.BINARY_EXPRESSION;
	}
	...
	public void setOperator(BinaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmnpl_variabilityPackage.BINARY_EXPRESSION__OPERATOR,
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bpmnpl_variabilityPackage.BINARY_EXPRESSION__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmnpl_variabilityPackage.BINARY_EXPRESSION__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmnpl_variabilityPackage.BINARY_EXPRESSION__LEFT,
					newLeft, newLeft));
	}
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bpmnpl_variabilityPackage.BINARY_EXPRESSION__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bpmnpl_variabilityPackage.BINARY_EXPRESSION__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmnpl_variabilityPackage.BINARY_EXPRESSION__RIGHT,
					newRight, newRight));
	}
