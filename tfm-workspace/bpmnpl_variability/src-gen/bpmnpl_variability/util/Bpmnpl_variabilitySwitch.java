 ...
 * @generated
 */
public class Bpmnpl_variabilitySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Bpmnpl_variabilitySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Bpmnpl_variabilityPackage.EXPRESSION: {
