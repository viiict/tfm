 ...
 * @generated
 */
public class Bpmnpl_variabilityPackageImpl extends EPackageImpl implements Bpmnpl_variabilityPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see bpmnpl_variability.Bpmnpl_variabilityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bpmnpl_variabilityPackageImpl() {
		super(eNS_URI, Bpmnpl_variabilityFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Bpmnpl_variabilityPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Bpmnpl_variabilityPackage init() {
		if (isInited)
			return (Bpmnpl_variabilityPackage) EPackage.Registry.INSTANCE
					.getEPackage(Bpmnpl_variabilityPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBpmnpl_variabilityPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Bpmnpl_variabilityPackageImpl theBpmnpl_variabilityPackage = registeredBpmnpl_variabilityPackage instanceof Bpmnpl_variabilityPackageImpl
				? (Bpmnpl_variabilityPackageImpl) registeredBpmnpl_variabilityPackage
				: new Bpmnpl_variabilityPackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(BpmnPackage.eNS_URI);
		BpmnPackageImpl theBpmnPackage = (BpmnPackageImpl) (registeredPackage instanceof BpmnPackageImpl
				? registeredPackage
				: BpmnPackage.eINSTANCE);

		// Create package meta-data objects
		theBpmnpl_variabilityPackage.createPackageContents();
		theBpmnPackage.createPackageContents();

		// Initialize created meta-data
		theBpmnpl_variabilityPackage.initializePackageContents();
		theBpmnPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBpmnpl_variabilityPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Bpmnpl_variabilityPackage.eNS_URI, theBpmnpl_variabilityPackage);
		return theBpmnpl_variabilityPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getVariability_Bpmn() {
	 ...
	 * @generated
	 */
	public Bpmnpl_variabilityFactory getBpmnpl_variabilityFactory() {
		return (Bpmnpl_variabilityFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(variabilityEClass, VARIABILITY__BPMN);
	...
	public void initializePackageContents() {
		...
		BpmnPackage theBpmnPackage = (BpmnPackage) EPackage.Registry.INSTANCE.getEPackage(BpmnPackage.eNS_URI);
		...
		initEAttribute(getFileURI_ImportURI(), ecorePackage.getEString(), "importURI", null, 1, 1, FileURI.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variabilityEClass, Variability.class, "Variability", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVariability_Bpmn(), this.getFileURI(), null, "bpmn", null, 1, 1, Variability.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariability_Featuremodel(), this.getFileURI(), null, "featuremodel", null, 1, 1,
				Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariability_Presencecondition(), this.getPresenceCondition(), null, "presencecondition", null,
				0, -1, Variability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(presenceConditionEClass, PresenceCondition.class, "PresenceCondition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPresenceCondition_Elements(), theBpmnPackage.getBPMNElement(), null, "elements", null, 1, -1,
				PresenceCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPresenceCondition_Expression(), this.getExpression(), null, "expression", null, 1, 1,
				PresenceCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_Feature(), ecorePackage.getEString(), "feature", null, 1, 1, Feature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUnaryExpression_Right(), this.getExpression(), null, "right", null, 1, 1,
		...
		initEClass(binaryExpressionEClass, BinaryExpression.class, "BinaryExpression", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBinaryExpression_Operator(), this.getBinaryOperator(), "operator", null, 1, 1,
	...
	protected void createCollectionAnnotations() {
		...
		addAnnotation(getVariability_Presencecondition(), source, new String[] { "nullFree", "false" });
		addAnnotation(getPresenceCondition_Elements(), source, new String[] { "nullFree", "false" });
	}

} //Bpmnpl_variabilityPackageImpl
