 ...
 * </p>
 * <ul>
 *   <li>{@link bpmn.impl.LaneImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LaneImpl extends SwimlaneImpl implements Lane {
	...
	public EList<BPMNElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<BPMNElement>(BPMNElement.class, this, BpmnPackage.LANE__ELEMENTS);
		}
		return elements;
	}
