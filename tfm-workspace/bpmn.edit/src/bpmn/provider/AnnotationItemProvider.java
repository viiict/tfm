...
public class AnnotationItemProvider extends ArtifactItemProvider {
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Annotation_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Annotation_description_feature",
								"_UI_Annotation_type"),
						BpmnPackage.Literals.ANNOTATION__DESCRIPTION, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case BpmnPackage.ANNOTATION__DESCRIPTION:
