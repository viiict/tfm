...
/**
 * This is the item provider adapter for a {@link bpmn.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider extends BPMNElementItemProvider {
	/**
	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_in_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_in_feature", "_UI_Flow_type"),
						BpmnPackage.Literals.FLOW__IN, true, false, true, null, null, null));
	}
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_out_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_out_feature", "_UI_Flow_type"),
						BpmnPackage.Literals.FLOW__OUT, true, false, true, null, null, null));
	}
