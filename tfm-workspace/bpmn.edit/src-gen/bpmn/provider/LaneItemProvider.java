	...
	protected void addElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Lane_elements_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Lane_elements_feature", "_UI_Lane_type"),
						BpmnPackage.Literals.LANE__ELEMENTS, true, false, true, null, null, null));
	}
