...
/**
 * This is the item provider adapter for a {@link bpmn.StartEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartEventItemProvider extends EventItemProvider {
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_StartEvent_message_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_StartEvent_message_feature",
								"_UI_StartEvent_type"),
						BpmnPackage.Literals.START_EVENT__MESSAGE, true, false, false,
	...
	public String getText(Object object) {
		String label = ((StartEvent) object).getID();
		return label == null || label.length() == 0 ? getString("_UI_StartEvent_type")
